...
export class BoardArticleService {
	...
	public async getBoardArticle(memberId: ObjectId, articleId: ObjectId): Promise<BoardArticle> {
		...
		const targteBoardArticle: BoardArticle = await this.boardArticleModel.findOne(search).lean().exec();
		if (!targteBoardArticle) throw new InternalServerErrorException(Message.NO_DATA_FOUND);
	...
	public async likeTargetBoardArticle(memberId: ObjectId, likeRefId: ObjectId): Promise<BoardArticle> {
		...
		const result = await this.boardArticleStasEditor({ _id: likeRefId, targetKey: 'articleLikes', modifier: modifier });
	...
	public async boardArticleStasEditor(input: StatisticModifier): Promise<BoardArticle> {
